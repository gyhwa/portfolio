...
<Container fluid>
  ...
  <Row xs={1} md={2}>
    <Col className="mb-4">
      <img width="100%" src={'../../images/lacquerpaintingsofvarioussubjectsbutterflies.jpg'} alt="original" />
      Original
    </Col>
    <Col className="mb-4">
      <video width="100%" height="100%" autoplay loop>
...
<Container fluid>
  ...
  <Row xs={1} md={2}>
    <Col className="mb-4">
      <img width="100%" src={'../../images/americangothic.jpg'} alt="original" />
      Original
    </Col>
    <Col className="mb-4">
      <video width="100%" height="100%" autoplay loop>
...
<Container fluid>
  ...
  <Row xs={1} md={2}>
    <Col className="mb-4">
      <img width="100%" src={'../../images/drinkers.jpg'} alt="original" />
      Original
    </Col>
    <Col className="mb-4">
      <video width="100%" height="100%" autoplay loop>
...
<Container fluid>
  ...
  <Row xs={1} md={2}>
    <Col className="mb-4">
      <img width="100%" src={'../../images/holyfamily.jpg'} alt="original" />
      Original
    </Col>
    <Col className="mb-4">
      <video width="100%" height="100%" autoplay loop>
